...
const char* ssid = "Evil";  // Enter your SSID here
const char* password = "123456789";  //Enter your Password here
const int wifi_channel = 11; //Enter your preferred Wi-Fi Channel
...
void force_reset() {
  esp_restart();  // Fuerza un reinicio inmediato del ESP32
}
void setup() {
...
controlserver.on("/listxmlfiles", HTTP_GET, [](AsyncWebServerRequest *request) {
    ...
    if (dir) {
        ...
        fileList = "Error al abrir el directorio.";
    }
...
controlserver.on("/getRawData", HTTP_GET, [](AsyncWebServerRequest *request){
  ...
  controlserver.on("/cleanspiffs", HTTP_GET, [](AsyncWebServerRequest *request){
    ...
    "<br><h2>LittleFS cleared!<br>You will be redirected in 5 seconds.</h2></body>" );
  });
